        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        @Html.LabelFor(Function(model) model.Correo, Idiomas.My.Resources.Resource.lbl_CorreoElectronico, New With {.class = "col-form-label"})
                    ...
                    <footer>
                        ...
                        <form action="#">
                            @For Each items In ViewBag.Roles
                                ...
                                Dim activo As Boolean = roles.Any(Function(r) r.RoleName = items.RoleName)

                                @<div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" name="l_Roles" value="@dataitem.RoleName" class="custom-control-input" data-role="@dataitem.RoleId" id="@String.Format("customCheck{0}", dataitem.RoleId)" @(If(activo, "checked=checked", ""))>
...
@Section Scripts
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var RolSelect = "@Html.Raw(ViewBag.RolSeleccionado)";
            ...
            if (RolSelect == "Regional") {
                $("#Ubicacion_Reg_chosen").show();
                $("#Mostradortext").show();
                $("#Ubicacion_Mostrador").hide();

            } else if ((RolSelect == "Cajero") || (RolSelect == "Vendedor"))  {
                $("#Ubicacion_Reg_chosen").hide();
                $("#Mostradortext").hide();
        ...
        function Almacenar() {
            ...
            toastr.info('Modificando Usuario...');
            $('#formUsuario').submit();
        }
