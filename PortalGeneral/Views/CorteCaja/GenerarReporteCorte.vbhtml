...
@Code
    ViewData("Title") = "Generar Reporte Corte Caja"
    ViewData("I_RCC") = "class=active"
...
<div style="display:none;">
    @Using Html.BeginForm("GenerarReporteCorteCajaPDF", "CorteCaja", FormMethod.Post, New With {.id = "ConsultarReporteCorteCaja"})
        @Html.AntiForgeryToken()
