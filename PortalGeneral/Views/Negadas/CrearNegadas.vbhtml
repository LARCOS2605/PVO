...
@Code
    ViewData("Title") = Idiomas.My.Resources.Resource.Title_Negadas
    ViewData("SubPage") = Idiomas.My.Resources.Resource.SubPage_Negadas
...
<div class="card">
    <div class="card-body">
        @*<h4 class="header-title">Generar Negada</h4>*@
        <h1>Generar Negada</h1>
    ...
    <div class="card" style="text-align: left;">
        ...
        <h4 class="header-title">Negadas.</h4>
        <div class="form-group">
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <button type="button" onclick="CrearOrdenVenta()" Class="btn btn-flat btn-primary mb-3">Almacenar Negadas</button>
               </fieldset>
                @<!--<fieldset>
                    <div class="card" style="text-align: left;">
...
<div style="display:none;">
    @Using Html.BeginForm("CrearListaProductos", "Negadas", FormMethod.Post, New With {.id = "AgregarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("ConsultarInventario", "Negadas", FormMethod.Post, New With {.id = "ConsultarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("EliminarArticuloCarrito", "Negadas", FormMethod.Post, New With {.id = "EliminarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("VaciarCarrito", "Negadas", FormMethod.Post, New With {.id = "VaciarCarrito"})
        @Html.AntiForgeryToken()
        @<input type="hidden" name="token" id="create-token" />
    End Using
</div>
