@modeltype PortalGeneral.SalesOrderMapViewModel
@Code
    ViewData("Title") = "Editar Orden de Venta"
    ViewData("I_SO") = "class=active"
...
<div class="card">
    <div class="card-body">
        <h4 class="header-title">Generar Pedido</h4>
        <div class="col-lg-12 mt-5">
            @Using Html.BeginForm(Nothing, Nothing, Nothing, FormMethod.Post, New With {.id = "msform"})
                ...
                @<ul id="progressbar">
                    ...
                    <li class="active" id="payment"><strong>Productos</strong></li>
                    <li id="confirm"><strong>Confirmación de Pedido</strong></li>
                </ul>
                @<fieldset>
                     <div class="card" style="text-align: left;">
                         ...
                         <div class="form-group">
                             <div class="row">
                                 <div class="col-lg-12">
                                     @Html.LabelFor(Function(model) model.Nombre_Cliente, "Cliente:", New With {.class = "col-form-label"})
                                     @Html.TextBoxFor(Function(model) model.Nombre_Cliente, New With {.class = "form-control", .readonly = True})
                                     @Html.ValidationMessageFor(Function(model) model.Nombre_Cliente)
                                 </div>
                             </div>
                         </div>
                         <br />
                         ...
                         <div class="form-group">
                             <div class="row">
                                 <div class="col-lg-12">
                                     <label class="col-form-label">Busqueda de Producto:</label>
                                     <div class="input-group-append">
                                         <input class="form-control" placeholder="-- Clave de Producto --" type="text" id="ClaveProducto">
                                         <input class="form-control" placeholder="-- Nombre del Producto --" type="text" id="NombreProducto">
                                         <button type="button" onclick="FindProducto()" class="btn btn-success" data-toggle="tooltip">Buscar Producto</button>
                                     </div>
                                 </div>
                             </div>
                         </div>
                         <div class="form-group">
                             <div class="row">
                                 <div class="col-lg-3">
                                     <label for="disabledTextInput">Código de Producto:</label>
                                     <input type="text" id="Clave" readonly class="form-control">
                                 </div>
                                 <div class="col-lg-3">
                                     <label for="disabledTextInput">No. De Lote:</label>
                                     <input type="text" id="NumeroLote" readonly class="form-control">
                                 </div>
                                 <div class="col-lg-3">
                                     <label for="disabledTextInput">Existencia:</label>
                         ...
                         <div class="form-group">
                             <div class="row">
                                 ...
                                 <div class="col-lg-3">
                                     <label for="disabledTextInput">Descuento Asignado:</label>
                         ...
                         <div class="form-group">
                             <button type="button" onclick="AddProducto()" class="btn btn-primary mb-3">Agregar Producto</button>
                         </div>
                                     ...
                                     <div class="single-table">
                                         <div class="table-responsive">
                                             <table id="TableMaterialInventario" class="table text-center">
                                                 ...
                                                 <tbody>
                                                     @For Each item In ViewBag.Detalle
                                                         Dim currentItem As DetalleSalesOrderMapViewModel = item
                                                         @<tr id="@currentItem.idSalesOrder">
                                                              <td scope="row">@currentItem.ClaveProducto</td>
                                                              <td scope="row">@currentItem.DescripcionProducto</td>
                                                              <td scope="row">@currentItem.NumLote</td>
                                                              <td scope="row">@Convert.ToDecimal(currentItem.Importe).ToString("C", New System.Globalization.CultureInfo("es-MX"))</td>
                                                              <td scope="row">@currentItem.Cantidad</td>
                                                              <td scope="row">@Convert.ToDecimal(currentItem.Total).ToString("C", New System.Globalization.CultureInfo("es-MX"))</td>
                                                              <td scope="row">
                                                                  <ul class="d-flex justify-content-center">
                                                                      <li class="mr-3" title="Agregar Cantidad"><a href="s" class="text-success"><i class="fa fa-plus-circle"></i></a></li>
                                                                      <li class="mr-3" title="Reducir Cantidad"><a href="s" class="text-danger"><i class="fa fa-minus-circle"></i></a></li>
                                                                      <li class="mr-3" title="Eliminar Articulo"><a href="s" class="text-secondary"><i class="fa fa-trash"></i></a></li>
                                                                  </ul>
                                                              </td>
                                                          </tr>
                                                     Next
                         ...
                         <div class="form-group">
                             <div class="row">
                                 <div class="col-lg-12">
                                     ...
                                     @Html.TextBoxFor(Function(model) model.Nota, New With {.class = "form-control"})
                ...
                @<fieldset>
                    ...
                    <button type="button" name="previous" class="previous btn btn-secondary mb-3">Anterior</button>
                    <button type="button" onclick="CrearOrdenVenta()" Class="btn btn-flat btn-primary mb-3">Guardar Cambios</button>
                </fieldset>
...
<div style="display:none;">
    @Using Html.BeginForm("CrearListaProductos", "OrdenesVenta", FormMethod.Post, New With {.id = "AgregarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("ConsultarInventario", "OrdenesVenta", FormMethod.Post, New With {.id = "ConsultarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("EliminarArticuloCarrito", "OrdenesVenta", FormMethod.Post, New With {.id = "EliminarProducto"})
        @Html.AntiForgeryToken()
...
<div style="display:none;">
    @Using Html.BeginForm("VaciarCarrito", "OrdenesVenta", FormMethod.Post, New With {.id = "VaciarCarrito"})
        @Html.AntiForgeryToken()
    End Using
</div>
...
@Section Scripts
    ...
    <script type="text/javascript">
        ...
        function AddProducto() {
            ...
            if ($('#Clave').val() == "" || $('#Descripcion').val() == "" || $('#StockDisponible').val() == "" || $('#NumeroLote').val() == "") {
        ...
        function CrearOrdenVenta() {
            ...
            showLoading("Creando Orden de Venta...");
