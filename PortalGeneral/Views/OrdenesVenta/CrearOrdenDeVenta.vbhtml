@modeltype PortalGeneral.SalesOrderViewModel
@Code
    ViewData("Title") = Idiomas.My.Resources.Resource.Title_CrearOV
    ViewData("SubPage") = Idiomas.My.Resources.Resource.SubPage_OV
        ...
        <div class="col-lg-12 mt-5">
            @Using Html.BeginForm(Nothing, Nothing, Nothing, FormMethod.Post, New With {.id = "msform"})
                    ...
                    <div class="card" style="text-align: left;">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label for="disabledTextInput">Existencia Muelles:</label>
                                    <input type="text" id="StockDisponibleMuelles" readonly class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                @<fieldset>
                    ...
                    <button type="button" name="previous" class="previous btn btn-secondary mb-3">Anterior</button>
                    <button type="button" onclick="CrearOrdenVenta()" Class="btn btn-flat btn-primary mb-3">Almacenar Orden de Venta</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            $("#NombreProducto").keyup(function (e) {
                ...
                var url = "@Url.Action("GetArticulo", "OrdenesVenta", New With {.id = "__ID__"})"
                        ...
                        if (data.Valor.length != 0) {
                            $.each(data.Valor, function (index, value) {
                                ...
                                if (value.Precio != 0) {
                                    ...
                                    $('#StockDisponibleMuelles').val(value.StockMuelles);
    ...
    $('#FormaPagoSAT').change(function () {
        var id = $('#FormaPagoSAT').val();
