...
@Code
    ViewData("Title") = "Consultar Estimación"
                ...
                <div class="card">
                    <div class="card-header">
                        <a class="card-link" data-toggle="collapse" href="#accordion21">
                            Consulta Avanzada Estimaciones
                        </a>
                    </div>
                    <div id="accordion21" class="collapse" data-parent="#accordion2">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <label for="example-text-input" class="col-form-label">No. De Estimación:</label>
            ...
            <div class="single-table">
                <div class="table-responsive">
                    <table id="TableOrdenesVenta" class="table table-hover progress-table text-center">
                        ...
                        <tbody>
                            @For Each item In ViewBag.Estimacion
                                Dim currentItem As NetsuiteLibrary.Clases.MapEstimaciones = item
    ...
    @*<td scope="row">
            ...
            ElseIf currentItem.Estatus.ClaveExterna = "SO_Entrega" Then
                @<span Class="badge badge-warning">
                    @currentItem.Estatus.Descripcionñ
                </span>
            ...
            End If
                                ...
                                <td scope="row">
                                    <ul class="d-flex justify-content-center">
                                        @If currentItem.Estatus <> "void" Then
...
<div style="display:none;">
    @Using Html.BeginForm("ConsultarEstimacionesDisponiblesVer2", "Estimaciones", FormMethod.Post, New With {.id = "ConsultarOrdenes"})
...
<div style="display:none;">
    @Using Html.BeginForm("CancelarEstimacion2", "Estimaciones", FormMethod.Post, New With {.id = "CancelarOrdenVenta"})
        @Html.AntiForgeryToken()
...
@Section Scripts
    ...
    <script>
        ...
        function DetallesPedido(id) {
            ...
            var Url_Datos = "@Url.Action("GetEstimacion", "Estimaciones", New With {.id = "__ID__"})"

            var link = Url_Datos.replace("__ID__", id);

            toastr.info("Obteniendo Detalles de la Estimación...");
        ...
        function CancelarOrdenVenta(id) {
            try {
                if (confirm("¿Desea Cancelar esta transacción? El proceso generara la cancelación de la estimación.")) {
                    if (confirm("Confirmar Cancelación.")) {
                        ...
                        var dataForm = form.serialize();
                        showLoading("Obteniendo Estimación...");
                        $.post(form.attr("action"), dataForm, function (data, textStatus, xhr) {
                            console.log(data);
                            if (data.Tipo == 1) {
                                hideLoading();
